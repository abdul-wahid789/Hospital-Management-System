...
public class PatientFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parent = inflater.inflate(R.layout.fragment_patient, container, false);
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(dataSnapshot.hasChild(username)){
                                ...
                                if(passFromFirebase.equals(password)){
                                    Intent patientHome=new Intent(resource,PatientHome.class);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent patientRegis=new Intent(resource,PatientSignUp.class);

 ...
 * Use the {@link ReceptionistFragment#newInstance} factory method to
...
public class ReceptionistFragment extends Fragment {
     ...
     * @return A new instance of fragment ReceptionistFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ReceptionistFragment newInstance(String param1, String param2) {
        ReceptionistFragment fragment = new ReceptionistFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parent = inflater.inflate(R.layout.fragment_receptionist, container, false);
        ...
        myRef = database.getReference("Receptionist");
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(dataSnapshot.hasChild(username)){
                                ...
                                if(passFromFirebase.equals(password)){
                                    Intent patientHome=new Intent(resource,ReceptionistHome.class);
                                    patientHome.putExtra("Current Receptionist",username);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent patientRegis=new Intent(resource,ReceptionistSignUp.class);

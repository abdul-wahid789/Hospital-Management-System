...
public class ReceptionistHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username= getIntent().getStringExtra("Current Receptionist");
    ...
    public void updateBtn(View view) {
        ...
        if(username.isEmpty()||password.isEmpty()||fullName.isEmpty()||email.isEmpty()||gender==null||ageStr.isEmpty()){
            ...
            Intent patientHome=new Intent(this,ReceptionistHome.class);

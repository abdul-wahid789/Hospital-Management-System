...
public class ReceptionistSignUp extends AppCompatActivity {
    EditText usernameField,passwordField,fullNameField,emailField,ageField;
    RadioGroup genderGroup;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_receptionist_sign_up);
    ...
    public void signUp(View view) {
        ...
        DatabaseReference myRef = database.getReference("Receptionist");
            ...
            myRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if(dataSnapshot.hasChild(username)){
                        ...
                        Intent logIn=new Intent(ReceptionistSignUp.this,MainActivity.class);
                        logIn.putExtra("User Receptionist",username);
                        startActivity(logIn);
                    }
